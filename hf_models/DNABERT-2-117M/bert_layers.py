...
# Flash attention kernels depend on Triton which is unavailable in this environment.
# Skip the optional import so the model always falls back to the pure PyTorch path.
